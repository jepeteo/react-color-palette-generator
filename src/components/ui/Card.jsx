...
function Card({
  ...
  const variants = {
    ...
    glass: ['bg-white/10', 'shadow-xl'],
    solid: ['bg-gray-900/90', 'shadow-2xl'],
    gradient: ['bg-gradient-to-br', 'from-white/10', 'to-white/5', 'shadow-xl'],
  };
  ...
  const bodyClasses = ['p-6', ...(bodyClassName ? [bodyClassName] : [])].join(
    ' ',
  );
