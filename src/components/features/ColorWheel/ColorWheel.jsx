      ...
      <div className="flex flex-col items-center space-y-4">
        ...
        <div className="relative">
          <svg width="240" height="240" className="drop-shadow-lg">
            ...
            {/* Center point */}
            <circle cx="120" cy="120" r="3" fill="rgba(255,255,255,0.5)" />
          </svg>
        </div>
        ...
        <div className="grid w-full grid-cols-1 gap-4 text-sm md:grid-cols-3">
          <div className="rounded-lg bg-white/5 p-3 text-center">
            <div className="mb-1 text-white/60">Harmony Type</div>
            <div className="font-medium capitalize text-white">
              {harmonyType}
            </div>
          </div>
          <div className="rounded-lg bg-white/5 p-3 text-center">
            <div className="mb-1 text-white/60">Color Count</div>
            <div className="font-medium text-white">
              {palette.colors.length}
            </div>
          </div>
          <div className="rounded-lg bg-white/5 p-3 text-center">
            <div className="mb-1 text-white/60">Hue Range</div>
            <div className="font-medium text-white">
        ...
        {/* Legend */}
        <div className="w-full rounded-lg border border-indigo-500/20 bg-indigo-500/10 p-3">
          <h5 className="mb-2 text-sm font-medium text-indigo-400">
            🎯 Harmony Guide
          </h5>
          <div className="space-y-1 text-xs text-indigo-300/80">
            <div>
              • <strong>Complementary:</strong> Colors opposite on the wheel
              (high contrast)
            </div>
            <div>
              • <strong>Triadic:</strong> Three colors evenly spaced (balanced)
            </div>
            <div>
              • <strong>Analogous:</strong> Adjacent colors (harmonious)
            </div>
            <div>
              • <strong>Monochromatic:</strong> Same hue, different shades
            </div>
          </div>
        </div>
      </div>
