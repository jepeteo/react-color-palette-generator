    ...
    // Analyze all color combinations
        ...
        // Check for issues
          ...
          recommendations.push(
            `Increase contrast between ${color1} and ${color2} to at least 4.5:1`,
          ...
          recommendations.push(
            `Increase contrast between ${color1} and ${color2} to at least 7:1`,
        }
            }
        }
              ...
              {/* Color Display with Simulation */}
                <div className="space-y-3">
                    <h4 className="text-white/90 font-medium">
                        Color Palette 
{' '}
{simulationMode !== 'none' && `(${simulationMode} simulation)`}
          </h4>
            ...
            <div className="max-h-64 space-y-2 overflow-y-auto">
                        ...
                        style={{
                          backgroundColor: getDisplayColor(pair.color1),
                        }}
                                          <span className="text-xs font-mono">{pair.color1}</span>
                                            ...
                                            <div
                                                className="w-4 h-4 rounded border border-white/20"
                        style={{
                          backgroundColor: getDisplayColor(pair.color2),
                        }}
                      />
...
{pair.contrast.toFixed(2)}:1</span>
                      <span
                      ...
                      >
                          ...
                          : 'FAIL'}
                                  ...
                                  <div className="text-xs text-white/60">
                                        AA: 
{' '}
{pair.passesAA ? '✓' : '✗'} Normal, 
{' '}
{pair.passesAALarge ? '✓' : '✗'} Large |
                                        AAA: 
{' '}
{pair.passesAAA ? '✓' : '✗'} Normal, 
{' '}
{pair.passesAAALarge ? '✓' : '✗'} Large
                                    </div>
                                </div>
                            ))}
                        </div>
...
{' '}
{wcagStandards[selectedStandard].normalText}:1
                        </div>
                        <div>
              <strong>Large Text:</strong>{' '}
              {wcagStandards[selectedStandard].largeText}:1
            </div>
                      <div>
                            <strong>Graphics:</strong> 
{' '}
{wcagStandards[selectedStandard].graphical}:1
                        </div>
                    </div>
                </div>
            </div>
