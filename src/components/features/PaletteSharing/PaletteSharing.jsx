...
import { selectPalette, selectPrimaryColor, selectHarmonyType } from '../../../store/slices/paletteSlice';
...
const PaletteSharing = () => {
  ...
  title="Color Palette">
    ...
    const generatePaletteImage = useCallback(() => {
        ...
        ctx.fillText(`${harmonyType || 'Custom'} Palette`, canvas.width / 2, canvas.height - 8);
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white/5 rounded-lg p-4">
                    ...
                    <div className="flex justify-between text-sm text-white/60">
                        ...
                        <span>{harmonyType || 'Custom'} harmony</span>
                    </div>
                </div>
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                            {Object.entries(socialShares).map(([platform, data]) => (
                                ...
                                >
                                    <span className="text-sm mt-1">{data.name}</span>
                                </Button>
                            ))}
                        </div>
                        ...
                        <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                            ...
                            <div className="bg-white/5 rounded p-3">
                                <div className="flex items-center gap-3">
                                    <div className="flex h-8 rounded overflow-hidden" style={{ width: '80px' }}>
                                        {palette.colors.map((color, index) => (
                                            <div
                                                key={index}
                                                className="flex-1"
