...
function PaletteSharing() {
  ...
  // Export as JSON (unused but kept for future use)
  ...
  const getDominantHue = (_colors) => {
    // Simplified hue calculation
    return Math.round(Math.random() * 360);
  };

  const getAverageLightness = (_colors) => {
    ...
    switch (shareFormat) {
      ...
      case 'json':
        return palette.colors
          ? JSON.stringify({ colors: palette.colors }, null, 2)
          : '';
      default:
        return '';
    }
    ...
    return (
      ...
      >
        <div className="py-8 text-center text-white/60">
          ...
          <p className="mb-2 text-lg">No palette to share</p>
    ...
    >
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex h-16 overflow-hidden rounded border border-white/20">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2 md:grid-cols-4">
            {shareFormats.map((format) => (
              ...
              >
                <div className="mb-1 text-2xl">{format.icon}</div>
        ...
        {(shareFormat === 'url' ||
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  disabled={
                    !currentShareContent ||
                    currentShareContent.includes('Click "Generate"')
                  }
                >
                  Copy
                </Button>
            ...
            <textarea
              ...
              readOnly
              className="h-24 w-full resize-none rounded border border-white/20 bg-white/10 px-3 py-2 font-mono text-sm text-white"
