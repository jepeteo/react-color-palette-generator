    ...
    >
      <div className="space-y-6">
        ...
        <div className="rounded-lg border border-white/10 bg-white/5 p-4">
          ...
          <p className="text-sm text-white/70">{currentCategory.description}</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          {currentCategory.palettes.map((palette, index) => (
            <div
              key={index}
              className="overflow-hidden rounded-lg border border-white/10 bg-white/5 transition-all duration-200 hover:bg-white/10"
        ...
        {/* Trend Insights */}
        <div className="rounded-lg border border-purple-500/20 bg-gradient-to-r from-purple-500/10 to-blue-500/10 p-6">
          ...
          <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
            <div>
              <h5 className="mb-2 font-medium text-purple-300">
                Current Trends
              </h5>
        ...
        <div className="rounded-lg border border-yellow-500/20 bg-yellow-500/10 p-4">
          <h5 className="mb-2 flex items-center font-medium text-yellow-300">
            <span className="mr-2">💡</span>
            Pro Tips
          </h5>
          <ul className="space-y-1 text-sm text-yellow-200/80">
            <li>
              • Use the variation button (🎲) to create unique versions of
              trending palettes
            </li>
            <li>
              • Test palettes in the Accessibility tab before finalizing your
              design
            </li>
            <li>
              • Combine trending colors with your brand's core colors for fresh
              looks
            </li>
            <li>
              • Save successful variations to your library for future projects
            </li>
          </ul>
        </div>
      </div>
