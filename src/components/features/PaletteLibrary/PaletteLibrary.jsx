          ...
          <div className="rounded-lg border border-white/20 bg-white/10 p-4">
            ...
            {/* Library Stats */}
                      <div className="flex items-center gap-4 text-sm text-white/60">
                            <span>
Total:{savedPalettes.length}
{' '}
palettes
</span>
                            <span>
Showing:{filteredAndSortedPalettes.length}</span>
                            {searchTerm && <span>
Search: "{searchTerm}
"
</span>}
                            {filterBy !== 'all' && <span>
Filter:{filterBy}</span>}
                        </div>
                    </div>
                )}
                  ...
                  {editingPalette === savedPalette.id ? (
                      ...
                      onBlur={(e) =>
                        updatePaletteName(savedPalette.id, e.target.value)
                              ...
                              {/* Color Swatches */}
                <div
                  className="mb-3 flex h-12 cursor-pointer overflow-hidden rounded"
                  onClick={() => loadPalette(savedPalette)}
                              ...
                              {/* Palette Metadata */}
                                <div className="space-y-1 text-xs text-white/60">
                                    <div className="flex justify-between">
                                        <span>
Harmony:{savedPalette.harmonyType}</span>
                                        <span>
{savedPalette.colors.length} colors</span>
                                    </div>
                                    <div className="flex justify-between">
                    <span>
                      Created:{' '}
