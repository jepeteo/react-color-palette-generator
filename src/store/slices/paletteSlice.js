  ...
  (palette, harmony) => {
    ...
    if (!palette.colors) {
      ...
      if (palette[PALETTE_ROLES.PRIMARY])
        colors.push(palette[PALETTE_ROLES.PRIMARY]);
      if (palette[PALETTE_ROLES.SECONDARY])
        colors.push(palette[PALETTE_ROLES.SECONDARY]);
      if (palette[PALETTE_ROLES.ACCENT])
        colors.push(palette[PALETTE_ROLES.ACCENT]);
      if (palette[PALETTE_ROLES.SURFACE])
        colors.push(palette[PALETTE_ROLES.SURFACE]);
      if (palette[PALETTE_ROLES.BACKGROUND])
        colors.push(palette[PALETTE_ROLES.BACKGROUND]);
