    ...
    reducers: {
        setPalette: (state, action) => {
            ...
            if (state.history.length === 0 ||
                JSON.stringify(state.palette) !== JSON.stringify(state.history[state.historyIndex])) {
...
export const selectCanRedo = (state) => state.palette.historyIndex < state.palette.history.length - 1;
